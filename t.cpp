...
long long int convertBinaryToDecimal(ll int n)
{
    ll int decimalNumber = 0, i = 0, remainder;
    while (n!=0)
    {
        remainder = n%10;
        n /= 10;
...
long long int convertDecimalToBinaryLength(ll int n)
{
    ll int binaryNumber = 0;
    ll int remainder, i = 1, step = 0;
...
int main()
{
    ...
    if(k==1)
        ...
        int len = convertDecimalToBinaryLength(n);
